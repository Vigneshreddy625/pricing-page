...
function Price() {
  ...
  const PriceYearly = ["$18", "$23", "$27", "$30"];
  const PriceMonthly = ["$23", "$28", "$32", "$35"];
  const Price = isOn ? PriceMonthly : PriceYearly ;
      ...
      <section class="hero">
        <div class="hero-container">
          ...
          <div class="hero-flex yearly">
            <p class="hero-p1">Pay annualy</p>
            <div
      onClick={ToggleSwitch}
      className={`w-16 h-8 flex items-center bg-gray-300 rounded-full p-1 cursor-pointer ${isOn ? 'bg-green-500' : 'bg-gray-500'}`}
    >
      <div
        className={`bg-white w-6 h-6 rounded-full shadow-md transform transition-transform ${isOn ? 'translate-x-8' : 'translate-x-0'}`}
      />
    </div>
            <p class="hero-p2">Pay monthly</p>
          </div>
        </div>
      </section>
        ...
        <div class="plan-container">
          <div class="plan-flex">
            <div class="plan-item">
              <h5>Personal</h5>
              <h2>
                <span class="plan-price">{Price[0]}</span>/mo
              </h2>
              <p class="plan-save">Save 30% annually</p>
            ...
            <div class="plan-item">
              <h5>Business</h5>
              <h2>
                <span class="plan-price">{Price[1]}</span>/mo
              </h2>
              <p class="plan-save">Save 30% annually</p>
              <p class="plan-content">
                Our foundational plan with access to fully customizable,
            ...
            <div class="plan-item">
              <h5>Commerse Basic</h5>
              <h2>
                <span class="plan-price">{Price[2]}</span>/mo
              </h2>
              <p class="plan-save">Save 30% annually</p>
              <p class="plan-content">
                Our foundational plan with access to fully customizable,
            ...
            <div class="plan-item">
              <h5>Commerse Advanced</h5>
              <h2>
                <span class="plan-price">{Price[3]}</span>/mo
              </h2>
              <p class="plan-save">Save 30% annually</p>
              <p class="plan-content">
                Our foundational plan with access to fully customizable,
        ...
        <div id="table" class="table-container">
          <table cellpadding="0" cellspacing="0" class="price-table">
            <thead class="table-heading">
              <tr>
                <th class="section-title css-11pi3d3">Start learning</th>
                <th class="css-udv16e">
